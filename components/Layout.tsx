        ...
        <div className="max-w-5xl px-8 mx-auto">
          <div className='flex'>
            <div className='pr-20'>
              ...
              <div className='font-semibold text-zinc-400'>의견 보내기</div>
            </div>
            <div className='pr-20'>
            ...
            <div className='pr-20'>
              ...
              <div className='font-semibold text-zinc-400'>전화: 018-1234-1234</div>
              <div className='font-semibold text-zinc-400'>이메일: dentium_official@dentium.com</div>
            </div>
          </div>
          ...
          <div className='flex py-10'>
            <div className='bg-zinc-100 w-10 h-10 rounded-full flex justify-center items-center'><IconBrandFacebookFilled size={30} stroke={1} fillOpacity={0.3}/></div>
            <div className='bg-zinc-100 w-10 h-10 rounded-full flex justify-center items-center'><IconBrandTwitterFilled size={30} stroke={1} fillOpacity={0.3}/></div>
            <div className='bg-zinc-100 w-10 h-10 rounded-full flex justify-center items-center'><IconBrandInstagram size={30} stroke={1} opacity={0.3}/></div>
          </div>
        </div>
      </footer>
    </>
